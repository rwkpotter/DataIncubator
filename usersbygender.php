<?php include_once('header.php'); ?>
		<div class="wrapper row2">
  			<div id="container" class="clear">
  				 <section class="clear">
			      	<figure>
			      		<h2 style="text-align:center; margin-bottom:15px; font-style:none; color:rgb(51,51,51); font-family: sans-serif;">Data analysis: Users by Gender</h2>
			      		<img src="img/journeysperqtr.png" alt="" style="width:20%; float:left; margin-right:50px;">
...
<!--
<img src="img/journeysperqtr.png" alt="" style="width:60%; float:left; margin-right:50px;">
-->